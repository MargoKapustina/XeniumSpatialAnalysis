#' Fetch UMAP_1 embedding values for cells and their distance away from Spatial Midline
...
#' @param FOV FOV to extract coordinates and UMAP_1 embedding values from
...
#' Plots UMAP_1 embedding values for cells and their distance away from the computed spatial midline (supports multiple FOVs)
#' @author Margarita Kapustina
#'
